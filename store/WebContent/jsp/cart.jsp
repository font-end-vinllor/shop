           ...
           <c:if test="${not empty cart.cartItems }"> 
					...
					<table class="table table-bordered">
						...
						<c:forEach items="${cart.cartItems }" var="ci">
							<tr class="active">
								...
								<td width="10%">
									<input type="text" name="quantity" readonly="readonly" value="${ci.count }" maxlength="4" size="10">
								</td>
								<td width="15%">
			...
			<div style="margin-right:130px;">
				<div style="text-align:right;">
					赠送积分: <em style="color:#ff6600;">596</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${cart.total }元</strong>
				</div>
